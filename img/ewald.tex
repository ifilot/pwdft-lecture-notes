\begin{tikzpicture}
    ...
    \fill[black!30] plot[domain=-9:-3, samples=100] 
    ...
    \fill[black!30] plot[domain=-5:1, samples=100] 
    ...
    \fill[black!30] plot[domain=-1:5, samples=100] 
    ...
    \fill[black!30] plot[domain=3:9, samples=100] 
