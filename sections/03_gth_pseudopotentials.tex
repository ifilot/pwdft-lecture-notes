...
Only the valence electrons are treated explicitly after this replacement. Outside a suitably chosen core region, a pseudo-valence orbital is made to reproduce the corresponding all-electron valence orbital. Inside this region, it is replaced by a smooth, nodeless function, as illustrated in \cref{fig:gth_pseudo_orbital}. The interaction responsible for producing this pseudo-orbital is the \textit{pseudopotential}.

\begin{Figure}
    \centering
    \includegraphics[width=\linewidth]{img/fig8_pseudo_orbital.pdf}
    \captionof{figure}{Representative radial construction comparing an all-electron valence orbital and a pseudo-valence orbital. Outside the core region, the pseudo-orbital matches the all-electron valence orbital. Inside the core region, the all-electron curve contains a node and stronger variation, whereas the pseudo-orbital is replaced by a smooth nodeless function that is easier to represent with plane waves.}
