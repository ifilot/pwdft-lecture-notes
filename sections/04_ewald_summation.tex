...
The charge $q_i$ in this expression is the ionic charge used by the chosen model. In an all-electron calculation this is the full nuclear charge $Z_i$, whereas in a pseudopotential calculation it is the effective ionic charge $Z_{\text{ion},i}=Z_i-N_{\text{core},i}$ associated with the selected pseudopotential.
...
\begin{Figure}
    ...
    \resizebox{0.9 \textwidth}{!}{
        \input{img/fig9_ewald_schematic}
    }
